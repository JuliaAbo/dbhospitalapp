...
public class validateOutcomeID implements IFunction<String,Boolean> {
  Connection conn;
  Appendable ap;

  public validateOutcomeID(Appendable ap, Connection conn) {
    this.ap = ap;
    this.conn = conn;
  }
  ...
  public Boolean apply(String arg) throws SQLException {
    ...
    try {
      String callValidation = "{CALL getOutcomeIDs}";
